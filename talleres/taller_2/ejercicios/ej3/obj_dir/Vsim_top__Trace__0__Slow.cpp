...
VL_ATTR_COLD void Vsim_top___024root__trace_full_0_sub_0(Vsim_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+10,((1U & ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__din) 
                                  >> 3U))));
    bufp->fullCData(oldp+11,(((((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__regis3__q) 
                                << 3U) | ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__regis2__q) 
                                          << 2U)) | 
                              (((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__regis1__q) 
                                << 1U) | (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__regis0__q)))),4);
    bufp->fullBit(oldp+12,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__regis0__q));
    bufp->fullBit(oldp+13,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__regis1__q));
    bufp->fullBit(oldp+14,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__regis2__q));
    bufp->fullBit(oldp+15,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__regis3__q));
    bufp->fullBit(oldp+16,(vlSelfRef.sim_top__DOT__clk));
    bufp->fullBit(oldp+17,(vlSelfRef.sim_top__DOT__rst));
    bufp->fullBit(oldp+18,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regis0__DOT__nuevo_ff_d__DOT__rst));
    bufp->fullBit(oldp+19,((1U & ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__we)
                                   ? (IData)(vlSelfRef.sim_top__DOT__tb__DOT__din)
                                   : (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__regis0__q)))));
    ...
    bufp->fullBit(oldp+21,((1U & ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__we)
                                   ? ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__din) 
                                      >> 2U) : (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__regis2__q)))));
    bufp->fullBit(oldp+22,((1U & ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__we)
                                   ? ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__din) 
                                      >> 3U) : (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__regis3__q)))));
}

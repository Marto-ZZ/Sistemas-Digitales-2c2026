...
void Vsim_top___024root__trace_chg_0_sub_0(Vsim_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[3U]))) {
        bufp->chgCData(oldp+11,(((((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__regis3__q) 
        ...
        bufp->chgBit(oldp+12,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__regis0__q));
        bufp->chgBit(oldp+13,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__regis1__q));
        bufp->chgBit(oldp+14,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__regis2__q));
        bufp->chgBit(oldp+15,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT____Vcellout__regis3__q));
    }
    bufp->chgBit(oldp+16,(vlSelfRef.sim_top__DOT__clk));
    bufp->chgBit(oldp+17,(vlSelfRef.sim_top__DOT__rst));
    bufp->chgBit(oldp+18,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regis0__DOT__nuevo_ff_d__DOT__rst));

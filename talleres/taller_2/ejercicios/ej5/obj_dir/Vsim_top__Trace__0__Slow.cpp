...
VL_ATTR_COLD void Vsim_top___024root__trace_init_sub__TOP__0(Vsim_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "regisuma", VerilatedTracePrefixType::SCOPE_MODULE, 0, 0);
    VL_TRACE_DECL_BIT(tracep,c+58,0,"clk",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BIT(tracep,c+60,0,"rst",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC);
...
VL_ATTR_COLD void Vsim_top___024root__trace_full_0_sub_0(Vsim_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+21,((1U & ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__we_s)
                                   ...
                                   : (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT____Vcellout__regis0__q)))));
    bufp->fullBit(oldp+22,(((IData)(vlSelfRef.sim_top__DOT__tb__DOT__we_s)
                             ? (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT__regis1__DOT__din)
                             : (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT____Vcellout__regis1__q))));
    bufp->fullBit(oldp+23,(((IData)(vlSelfRef.sim_top__DOT__tb__DOT__we_s)
                             ? (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT__regis2__DOT__din)
                             : (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT____Vcellout__regis2__q))));
    bufp->fullBit(oldp+24,(((IData)(vlSelfRef.sim_top__DOT__tb__DOT__we_s)
                             ? (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT__regis3__DOT__din)
                             : (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT____Vcellout__regis3__q))));
    bufp->fullCData(oldp+25,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regis4b1__DOT__q),4);
    bufp->fullCData(oldp+26,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regis4b2__DOT__q),4);
    bufp->fullCData(oldp+27,(((((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT____Vcellout__regis3__q) 
                                << 3U) | ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT____Vcellout__regis2__q) 
                                          << 2U)) | 
                              (((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT____Vcellout__regis1__q) 
                                << 1U) | (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT____Vcellout__regis0__q)))),4);
    bufp->fullBit(oldp+28,((1U & (((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_0) 
                                   >> 3U) | ((((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_0) 
                                             ...
                                             & ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_1) 
                                                >> 3U))))));
    bufp->fullCData(oldp+29,(((((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT__regis3__DOT__din) 
                                << 3U) | ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT__regis2__DOT__din) 
                                          << 2U)) | 
                              (((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT__regis1__DOT__din) 
                                << 1U) | (1U & (IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_1))))),4);
    bufp->fullBit(oldp+30,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regis4b1__DOT____Vcellout__regis0__q));
    bufp->fullBit(oldp+31,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regis4b1__DOT____Vcellout__regis1__q));
    bufp->fullBit(oldp+32,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regis4b1__DOT____Vcellout__regis2__q));
    bufp->fullBit(oldp+33,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regis4b1__DOT____Vcellout__regis3__q));
    bufp->fullBit(oldp+34,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regis4b2__DOT____Vcellout__regis0__q));
    bufp->fullBit(oldp+35,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regis4b2__DOT____Vcellout__regis1__q));
    bufp->fullBit(oldp+36,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regis4b2__DOT____Vcellout__regis2__q));
    bufp->fullBit(oldp+37,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regis4b2__DOT____Vcellout__regis3__q));
    bufp->fullBit(oldp+38,((1U & (IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_1))));
    bufp->fullBit(oldp+39,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT____Vcellout__regis0__q));
    bufp->fullBit(oldp+40,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT__regis1__DOT__din));
    bufp->fullBit(oldp+41,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT____Vcellout__regis1__q));
    bufp->fullBit(oldp+42,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT__regis2__DOT__din));
    bufp->fullBit(oldp+43,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT____Vcellout__regis2__q));
    bufp->fullBit(oldp+44,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT__regis3__DOT__din));
    bufp->fullBit(oldp+45,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT____Vcellout__regis3__q));
    ...
    bufp->fullBit(oldp+60,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regis4b1__DOT__regis0__DOT__nuevo_ff_d__DOT__rst));
}

    ...
    __Vtask_sim_top__DOT__tb__DOT__expect_eq__4__got 
        = ((((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT____Vcellout__regis3__q) 
             << 3U) | ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT____Vcellout__regis2__q) 
                       << 2U)) | (((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT____Vcellout__regis1__q) 
    ...
    if ((1ULL & vlSelfRef.__VnbaTriggered[0U])) {
        {
            ...
            vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT____Vcellout__regis3__q 
                = ((1U & (~ (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regis4b1__DOT__regis0__DOT__nuevo_ff_d__DOT__rst))) 
                   && (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT__regis3__DOT__nuevo_ff_d__DOT__d));
            vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT____Vcellout__regis2__q 
                = ((1U & (~ (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regis4b1__DOT__regis0__DOT__nuevo_ff_d__DOT__rst))) 
                   && (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT__regis2__DOT__nuevo_ff_d__DOT__d));
            vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT____Vcellout__regis1__q 
                = ((1U & (~ (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regis4b1__DOT__regis0__DOT__nuevo_ff_d__DOT__rst))) 
                   && (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT__regis1__DOT__nuevo_ff_d__DOT__d));
            vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT____Vcellout__regis0__q 
                = ((1U & (~ (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regis4b1__DOT__regis0__DOT__nuevo_ff_d__DOT__rst))) 
                   && (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regisuma__DOT__regis0__DOT__nuevo_ff_d__DOT__d));
            ...
            vlSelfRef.__VdfgRegularize_h6e95ff9d_0_0 
                = ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__regis4b1__DOT__q) 

...
VlCoroutine Vsim_top___024root___eval_initial__TOP__Vtiming__0(Vsim_top___024root* vlSelf) {
    ...
    while (VL_LTS_III(32, 0U, sim_top__DOT__unnamedblk1_1__DOT____Vrepeat0)) {
        ...
        co_await vlSelfRef.__VtrigSched_hffd278f5__0.trigger(0U, 
                                                             nullptr, 
                                                             "@(posedge sim_top.clk)", 
                                                             "/workspaces/Sistemas-Digitales-2c2026/talleres/taller_1/ejercicios/lib/sim_top.sv", 
                                                             16);
    ...
    if (VL_UNLIKELY(((1U & (~ (IData)(vlSelfRef.sim_top__DOT__tb__DOT__oracle__DOT__tests_passing)))))) {
        ...
        VL_STOP_MT("/workspaces/Sistemas-Digitales-2c2026/talleres/taller_1/ejercicios/lib/sim_top.sv", 20, "", false);
    }
    VL_FINISH_MT("/workspaces/Sistemas-Digitales-2c2026/talleres/taller_1/ejercicios/lib/sim_top.sv", 21, "");
    co_return;
}
...
VlCoroutine Vsim_top___024root___eval_initial__TOP__Vtiming__1(Vsim_top___024root* vlSelf) {
    ...
    while ((1U & (~ (IData)(vlSelfRef.sim_top__DOT__done)))) {
        ...
        co_await vlSelfRef.__VtrigSched_hde298250__0.trigger(1U, 
                                                             nullptr, 
                                                             "@( sim_top.done)", 
                                                             "/workspaces/Sistemas-Digitales-2c2026/talleres/taller_1/ejercicios/lib/oracle_tb.sv", 
                                                             47);
    }
...
void Vsim_top___024root___nba_sequent__TOP__0(Vsim_top___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    CData/*0:0*/ sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__c2;
    sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__c2 = 0;
    CData/*0:0*/ sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s3__DOT__d1;
    sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s3__DOT__d1 = 0;
    CData/*0:0*/ sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s2__DOT__d1;
    sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s2__DOT__d1 = 0;
    CData/*0:0*/ sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s1__DOT__c1;
    sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s1__DOT__c1 = 0;
    CData/*0:0*/ sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__r3__DOT__b1;
    sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__r3__DOT__b1 = 0;
    CData/*0:0*/ sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__r2__DOT__b1;
    sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__r2__DOT__b1 = 0;
        ...
        if ((1U & (~ (IData)(vlSelfRef.sim_top__DOT__tb__DOT__oracle__DOT__first)))) {
            if (VL_UNLIKELY(((1U & (~ (((1U & ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__exp) 
                                        ...
                                        == (1U & ((0x00000100U 
                                                   & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__value))
                                                   ? 
                                                  ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__r4__DOT__b1) 
                                                   | ((~ 
                                                       ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_0) 
                                                        >> 3U)) 
                                                      & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__b3)))
                                                   : 
                                                  (((~ (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s4__DOT__d1)) 
                                                    & ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_1) 
                                                       >> 3U)) 
                                                   | ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s4__DOT__d1) 
                                                      & ((~ (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s1__DOT____Vcellout__s4__sum)) 
                                                         & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__c3))))))) 
                                       & ((0x0000000fU 
                                          ...
                                          == ((0x00000100U 
                                               ...
                                               ? ((
                                                   (((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__b3) 
                                                    ...
                                                    << 3U) 
                                                   | (4U 
                                                      & (((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__b2) 
                                                          << 2U) 
                                                         ^ 
                                                         (0xfffffffcU 
                                                          & (IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_0))))) 
                                                  | ((2U 
                                                      & (((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__r1__DOT__b1) 
                                                          << 1U) 
                                                         ^ 
                                                         (0xfffffffeU 
                                                          & (IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_0)))) 
                                               ...
                                               : ((
                                                   ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s1__DOT____Vcellout__s4__sum) 
                                                    << 3U) 
                                                   | ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s1__DOT____Vcellout__s3__sum) 
                                                      << 2U)) 
                                                  | (((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s1__DOT____Vcellout__s2__sum) 
                                                      << 1U) 
                                                     | (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s1__DOT__d1))))))))))) {
                                            ...
                                            & ((0x00000100U 
                                                ...
                                                : (
                                                   ...
                                                   (0x0000000fU 
                                                    & ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__value) 
                                                       >> 4U)))));
    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__r4__DOT__b1 
        = (IData)((8U == (0x0088U & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__value))));
    vlSelfRef.__VdfgRegularize_h6e95ff9d_0_0 = (0x0000000fU 
                                                & (((IData)(vlSelfRef.sim_top__DOT__tb__DOT__value) 
                                                    >> 4U) 
                                                   ^ (IData)(vlSelfRef.sim_top__DOT__tb__DOT__value)));
    sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__r3__DOT__b1 
        = (IData)((4U == (0x0044U & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__value))));
    sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__r2__DOT__b1 
        = (IData)((2U == (0x0022U & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__value))));
    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__r1__DOT__b1 
        = (IData)((1U == (0x0011U & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__value))));
    vlSelfRef.__VdfgRegularize_h6e95ff9d_0_1 = (0x0000000fU 
                                                & (((IData)(vlSelfRef.sim_top__DOT__tb__DOT__value) 
                                                    >> 4U) 
                                                   & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__value)));
    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s4__DOT__d1 
        = ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__r4__DOT__b1) 
           | (0x0080U == (0x0088U & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__value))));
    sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s3__DOT__d1 
        = ((IData)(sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__r3__DOT__b1) 
           | (0x0040U == (0x0044U & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__value))));
    sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s2__DOT__d1 
        = ((IData)(sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__r2__DOT__b1) 
           | (0x0020U == (0x0022U & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__value))));
    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__b2 
        = ((IData)(sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__r2__DOT__b1) 
           | ((~ ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_0) 
                  >> 1U)) & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__r1__DOT__b1)));
    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s1__DOT__d1 
        = ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__r1__DOT__b1) 
           | (0x0010U == (0x0011U & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__value))));
    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__b3 
        = ((IData)(sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__r3__DOT__b1) 
           | ((~ ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_0) 
                  >> 2U)) & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__r1__DOT__b2)));
    sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s1__DOT__c1 
        = (1U & ((~ (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s1__DOT__d1)) 
                 & (IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_1)));
    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s1__DOT____Vcellout__s2__sum 
        = (((~ (IData)(sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s2__DOT__d1)) 
            & (IData)(sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s1__DOT__c1)) 
           | ((~ (IData)(sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s1__DOT__c1)) 
              & (IData)(sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s2__DOT__d1)));
    sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__c2 = 
        (1U & (((~ (IData)(sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s2__DOT__d1)) 
                & ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_1) 
                   >> 1U)) | ((IData)(sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s2__DOT__d1) 
                              & ((~ (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s1__DOT____Vcellout__s2__sum)) 
                                 & (IData)(sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s1__DOT__c1)))));
    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s1__DOT____Vcellout__s3__sum 
        = (((~ (IData)(sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s3__DOT__d1)) 
            & (IData)(sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__c2)) 
           | ((~ (IData)(sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__c2)) 
              & (IData)(sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s3__DOT__d1)));
    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__c3 
        = (1U & (((~ (IData)(sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s3__DOT__d1)) 
                  & ((IData)(vlSelfRef.__VdfgRegularize_h6e95ff9d_0_1) 
                     >> 2U)) | ((IData)(sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s3__DOT__d1) 
                                & ((~ (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s1__DOT____Vcellout__s3__sum)) 
                                   & (IData)(sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__c2)))));
    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s1__DOT____Vcellout__s4__sum 
        = (((~ (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s4__DOT__d1)) 
            & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__c3)) 
           | ((~ (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__c3)) 
              & (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__s1__DOT__s4__DOT__d1)));
...
bool Vsim_top___024root___eval_phase__inact(Vsim_top___024root* vlSelf) {
    ...
    if (__VinactExecute) {
        VL_FATAL_MT("/workspaces/Sistemas-Digitales-2c2026/talleres/taller_1/ejercicios/lib/sim_top.sv", 5, "", "ZERODLY: Design Verilated with '--no-sched-zero-delay', but #0 delay executed at runtime");
    }
...
#endif
            VL_FATAL_MT("/workspaces/Sistemas-Digitales-2c2026/talleres/taller_1/ejercicios/lib/sim_top.sv", 5, "", "DIDNOTCONVERGE: NBA region did not converge after '--converge-limit' of 10000 tries");
        }
        __VnbaIterCount = ((IData)(1U) + __VnbaIterCount);
        vlSelfRef.__VinactIterCount = 0U;
        do {
            if (VL_UNLIKELY(((0x00002710U < vlSelfRef.__VinactIterCount)))) {
                VL_FATAL_MT("/workspaces/Sistemas-Digitales-2c2026/talleres/taller_1/ejercicios/lib/sim_top.sv", 5, "", "DIDNOTCONVERGE: Inactive region did not converge after '--converge-limit' of 10000 tries");
            }
            ...
            do {
                if (VL_UNLIKELY(((0x00002710U < vlSelfRef.__VactIterCount)))) {
                    ...
                    Vsim_top___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                    VL_FATAL_MT("/workspaces/Sistemas-Digitales-2c2026/talleres/taller_1/ejercicios/lib/sim_top.sv", 5, "", "DIDNOTCONVERGE: Active region did not converge after '--converge-limit' of 10000 tries");
                }

...
class alignas(VL_CACHE_LINE_BYTES) Vsim_top___024root final {
  public:
    ...
    CData/*0:0*/ sim_top__DOT__tb__DOT__dut__DOT____Vcellout__s1__sum;
    CData/*0:0*/ sim_top__DOT__tb__DOT__dut__DOT____Vcellout__s2__sum;
    CData/*0:0*/ sim_top__DOT__tb__DOT__dut__DOT____Vcellout__s3__sum;
    CData/*0:0*/ sim_top__DOT__tb__DOT__dut__DOT____Vcellout__s4__sum;
    CData/*0:0*/ sim_top__DOT__tb__DOT__dut__DOT__s4__DOT__d1;
